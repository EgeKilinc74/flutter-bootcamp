        ...
        child: Center(
          child: Column(
            children: [
              ...
              children: [
                ElevatedButton(onPressed: (){
                  resimYolu ="resimler/happy.png";
                  setState(() {
                  });
                }, child: Text("Happy") ),
                SizedBox(child: Image.asset(resimYolu),width: 20,height: 20,),
                ElevatedButton(onPressed: (){
                  resimYolu="resimler/sad.png";
                  setState(() {
                  });
                }, child: Text("Sad")),
              ],
